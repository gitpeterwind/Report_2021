...
\newcolumntype{H}{@{}>{\lrbox0}l<{\endlrbox}}   % to skip columns
...
%\includeonly{acknow}
%\includeonly{ExSummary,chapterStatus2019,chapterTrendsSandN,chapterAPPX_ModelEval}
%\includeonly{chapterMeasurementDevelopments}
%\includeonly{chapterStatus2019,chapterEmis2019}
...
\ifthenelse{\boolean{draftactive}}{\include{chapterGIT}}{}
...
\include{chapterIntro} %For Hilde & Agnes


\part{Status of air pollution}
\include{chapterStatus2019} 
\include{chapterEmis2019} 

\part{Trends in air pollution} 

\include{chapterTrendsSandN} %Wenche, Hilde, Svetlana (Jonas/Augustin about how the trends have been calculated)
%\include{chapterTrendsOzone} %Sverre, David, Joffen
%\include{chapterTrendsECOC} % KE, Dave, ...
%\include{chapterTrendsOCandSIA} %Karl-Espen, David

\part{Technical EMEP Developments}
\include{chapterEMEPModelUpdates}
\include{chapterMeasurementDevelopments}
...
\include{chapterAPPX_EMIS_2019}
\include{chapterAPPX_EMIS_trends}
\include{chapterAPPX_trends}
\include{chapterAPPX_SR_2019}
\include{chapterAPPX_CountryRep}
\include{chapterAPPX_ModelEval}
