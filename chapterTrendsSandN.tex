...
Comparison of trends in measured and modelled VOCs is not included in this report. The main reasons are the lack of established procedures for doing such a comparison as well as the lack of proper monitoring sites with sufficient data capture and sufficient homogeneity in the monitoring. 
\SKIP{The lumped VOCs in the model could not be compared directly with measured species.}
The topic of VOC trends will be investigated in more detail in the near future. 
...
For the whole period, 36 and 18 sites with satisfactory data coverage have been included in the trend analysis for \PM[10] and \PM[2.5] respectively. The annual series of \PM[10] and \PM[2.5] show clear concentration decreases from 2000 to 2019 both in the observations and in the model calculations 
 %HF NEW:
 For \PM[10] the relative reductions in observations and model calculations are on average 1.83 \% $yr^{-1}$ and 1.92 \% $yr^{-1}$ respectively, whilst reductions are on average 2.42\% $yr^{-1}$ and 2.51\% $yr^{-1}$ for \PM[2.5]. The larger reductions in \PM[2.5] than in \PM[10] can be explained by the larger natural contribution of sea salt and dust in the coarse fraction. 
...
directly and formed from gaseous precursors. Therefore, the reductions both in primary PM emissions, as well as \sox, \noii, \nhiii and NMVOC emissions are contribute to decreased PM concentrations. 

During the 2000-2019 period, \soiv, \noii and \nhiv decreased on average 3.2 (3.8), 2.0 (2.5) and 2.6 (2.6) \% in the long term EMEP observations (model calculations), contributing substantially to the \PM[10] and \PM[2.5] decreases.


In the western parts of EMEP (EU \&UK \&EFTA), where the considered sites are located, the emissions of primary \PM[10] and \PM[2.5] were reduced by 32 and 35 \%, respectively, from 2000 to 2019. %The largest in the same period was the reduction in \sox emissions (81 \%), resulting in 61 \% observed decrease of \soiv (70 \% according to the model). Following the reduction of \noii emissions by 48 \%, observed \noiii concentrations decreased slightly less, i.e. by 38 \% (44 \% according to the model). This was partly due to a rather moderate reduction by 12 \% in \nhiii emissions and the availability of free \nhiii due to the reduced formation of ammonium sulphate. 
...
%\COMMENT{Though \noii was reduced by 48 \%, given the moderate reduction by 12 \% in \nhiii emissions and the availability of free \nhiii due to the reduced formation of ammonium sulphate, the observed decrease in \noiii concentrations was only 38 \% (44 \% by the model).}
 ...
 %HF Something on OC/EC trends
 During this period, EC was found to decrease substantially (around 4.5~\%/yr in observations)
 The examples of the changes in the chemical composition of \PM[2.5] from 2000(2002) to 2019 are given on Figure \ref{fig:KEX4} for the four of the sites with enough measurements for deriving the mass balance. 
...
Figure \ref{fig:pmExc_trends} indicates that the number of sites with exceedances of WHO AQG decrease for both \PM[10] and \PM[2.5] in the observations, although it should be noted that the number of sites with exceedances are small and thus the analysis not very robust. The model results also show a decrease in the number of sites with exceedances for \PM[2.5], whilst it in general fails to reproduce the exceedances for \PM[10].
