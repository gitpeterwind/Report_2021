...
In the period of 2000-2019, the average observed \PM[10] trends are -0.37 \ug $yr^{-1}$, or -1.86 \% $yr^{-1}$ in relative terms. The corresponding \PM[10] trends from model simulations are -0.28 \ug $yr^{-1}$ and -1.91 \% $yr^{-1}$.


-0.37 and -0.31 \ug $yr^{-1}$ for \PM[10] and \PM[2.5]; the modelled ones are somewhat smaller, i.e. -0.28 and -0.25 \ug $yr^{-1}$ respectively (partly due to model underestimation of PM concentration). The model simulated relative trends are -1.91 and -2.51 \% $yr^{-1}$ for \PM[10] and \PM[2.5], which agree well with observed -1.86 and -2.51 \% $yr^{-1})$, respectively. Significant trends have been derived from the observational data for 80 \% of sites for \PM[10] and 97 \% of sites for \PM[2.5]; the model simulates significant trends for more sites, namely 97 and 100 \% respectively.  
