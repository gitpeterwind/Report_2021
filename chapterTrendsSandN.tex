...
\includegraphics[width=16cm]{FIGS_TRENDS/Composition_4sites.png}
 \caption{
  ...
  (PL05) and Iskrba (SI08) including OM, EC, \ce{SO4^2-}, \ce{NO3^-}, \ce{NH4^+} from 
  ...
  (\ebcbb) for winter 2017/2018 (right). Note that at NO02 and PLo5 the SIA componets are from  \label{fig:KEX4}
 }
\end{figure}
...
\COMMENT{DS: JUST STARTED!!! Probably need to move, but put here for Wenche and Karl Espen to check. ISSUE:  p-values of 1 look odd.}
