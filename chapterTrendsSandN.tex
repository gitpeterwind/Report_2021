...
{\bf{Authors,Jonas, Eivind, Hans, Jan, Thomas Scheuschner}}\\
...
\COMMENT{WAa: Something on how to get aggregated trends...:}
...
\begin{figure}[h]
  \centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_NO2_2000-2019_Perc.pdf}}
%  \vspace{0.5cm}
  \centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_TNO3_2000-2019_Perc.pdf}}
\centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_NO3_2000-2019_Perc.pdf}}
\centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_WDEP_OXN_2000-2019_Perc.pdf}}
...
\begin{figure}[h]
  \centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_TNH4_2000-2019_Perc.pdf}}
%  \vspace{0.5cm}
  \centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_NH4_2000-2019_Perc.pdf}}
\centering{\includegraphics[clip=,angle=90,height=3.1cm,viewport=175 67 448 754]{FIGS_TRENDS/RelTrend_WDEP_RDN_2000-2019_Perc.pdf}}
...
\begin{table}
\caption{\label{tab:O3_stat} The estimated mean values of the absolute and relative trends in O$_3$ metrics based on all stations (observed and modelled). The corresponding 95\% confidence intervals of these mean values and the number of sites with significant trends are also provided.}
\begin{center}
\scalebox{0.65}{%
...
Period & Area & Param &           total & obs & mod &                    obs. &          conf.interval &  mod. &          conf.interval &                     obs. &         conf.interval &  mod. &        conf.interval \\
\midrule
2000-2019 & N of 49N & 75p &  52 &  19 &  30 & -0.20 & (-0.19, -0.09) & -0.26 & (-0.14, -0.10) & -0.35 & (-0.40, -0.21) & -0.46 & (-0.30, -0.22) \\
2000-2019 & N of 49N & 99p &  52 &  13 &  39 & -0.48 & (-0.48, -0.33) & -0.51 & (-0.38, -0.30) & -0.57 & (-0.68, -0.46) & -0.70 & (-0.59, -0.49) \\
2000-2019 & S of 49N & 75p &  40 &  16 &  38 & 0.00 & (-0.26, -0.12) & 0.00 & (-0.27, -0.23) & 0.00 & (-0.46, -0.23) & 0.00 & (-0.49, -0.43) \\
2000-2019 & S of 49N & 99p &  40 &  18 &  37 & 0.00 & (-0.58, -0.37) & 0.00 & (-0.54, -0.46) & 0.00 & (-0.71, -0.43) & 0.00 & (-0.74, -0.65) \\
\bottomrule
\end{tabular}}
\end{center}
\end{table}
...
Table~\ref{tab:KEX1} presents the absolute and relative changes over 2010-2019 from 15 EMEP sites, as annual values, and with confidence intervals, and from both observed and modelled values. The spatial variation of these trends for summer and winter can be seen as `arrow' plots in Fig.~\ref{fig:ECarrows}, and Fig.\ref{fig:ECtrends} shows again the annual trends, but superimposed upon the modelled field of modelled EC.
%
A 4.5$\pm$1.5\%/yr reduction (Tab.~\ref{tab:KEX1}) 
 \COMMENT{DS: changed "-X\%" xx reduction to just X\% reduction. Should be careful throughout... very inconsistent now}
...
%
Figure~\ref{fig:OCarrows} makes it clear that there were large differences in both sign and magnitude of the summertime trends in OC, in both modelled and observed results. For the winter trends, Fig.~\ref{fig:OCarrows} shows that essentially all observed trends were reductions, whereas the modelled trends were more variable and less significant.
...
OC   & annual  &  -0.44 (0.876)      &   0.18 (1.0)     & -0.64 (1.0)   \\
Levo & annual  & -2.5 (0.043)        &  -2.48 (0.024)   & -5.2  (0.032) \\
& & & & \\
\hline
\end{tabular}\\
\parbox{12cm}{
...
differ slightly from results of \citet{Yttri2021}, which had -4.2\%Yr for EC and -2.8\%/yr for levoglucosan.
\COMMENT{ISSUES: Explain more diffs from Yttro2021 and 2008-2018 trends above.\\
p-values of 1 look odd.}\\
}
\end{table}


Fig.~\ref{fig:KEX1} illustrates the statistics of the reductions in EC and OC  over the period 2010-2019, and for different seasons. For EC the model is seen to capture the year to year changes very well over the ten years, and captures well the relative changes which are ca. -4\% in all seasons. Larger differences are seen in the absolute changes (which may reflect the difficulties with the EC emissions mentioned in Sect.~\ref{ss:IssuesECOC}).


As discussed in Sect.~\ref{ss:trendsEC} there is only a minor seasonal variability in the reduction of EC. This probably reflects the minor seasonal variability in most EC sources, except from
...
Unlike EC, OC has a substantial influence from
...
\parbox{14cm}{
 \caption{
   Absolute and relative change and the corresponding 95\% confidence intervals in observed and modeled annual and seasonal    aggregated OC/\pmfine and EC/\pmfine ratios at 15 sites across Europe
   for 2010--2020. The number of sites with a significant outcome is provided.\label{tab:KEX3}
 }}
 \scalebox{0.95}{%
