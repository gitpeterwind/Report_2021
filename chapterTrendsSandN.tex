...
At first sight, the 2010-2019 reduction of 4.2\%/yr in observed EC across all seasons is rather dramatic, though as noted above a different choice if time-window might suggest a lower magnitude of changes. Presumably 
...
\begin{figure}
    \centering
    \includegraphics[width=12cm,trim=0 0 0 1.5cm]{FIGS_TRENDS/PlotEmisTrends_PM2_5.png}
