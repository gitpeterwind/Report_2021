...
for the Norwegian Birkenes Observatory \citep{Yttri2021}. This suggests a large-scale reduction in EC emissions.
...
Unlike EC, the observed seasonal trends for OC (c.f. Fig.~\ref{fig:KEX1} are very variable, with strong (ca. 4\%) reductions in the winter months (both DJF and SON), and essentially no change in summertime.
