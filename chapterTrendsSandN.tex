...
Fig.~\ref{fig:KEX1} illustrates the statistics of the reductions in OC  over the period 2010-2019, and for different seasons. For OC the model substantially underpredicts the yearly concentrations over the whole period, and also underpredicts the trends. There is substantial seasonal variation though. Observed reductions in winter (DJF) of ca. -4\%/yr are are not redthe  substa.aptures well the relative changes which are ca. -4\% in all seasons. Larger differences are seen in the absolute changes (which may reflect the difficulties with the EC emissions mentioned in Sect.~\ref{ss:IssuesECOC}).
...
\COMMENT{ISSUES: Explain more diffs from Yttri2021 and 2008-2018 trends above.\\
...
calculated for levoglucosan for 2008--2018 and for 2010--2019.

A statistically significant downward trend of similar magnitude
(-4.2\%/yr) was calculated for EC for 2010--2019 as for 2001--2018
