...
%Ozone Sverre
Trends in six annual percentiles of daily maximum O$_3$ as well as three aggregated metrics (AOT40 for crops, AOT40 for forests and SOMO35) were calculated for the period 2000-2019. For the high percentiles as well as for the three metrics both the model values and the observations show a decrease during this period as an average. For stations north of 49 \degrees N ..
