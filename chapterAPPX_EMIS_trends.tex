...
Poland, Russian Federation, Slovakia, Turkey and Ukraine. In this report 1) is referred to as EMEP and 2) is referred to as EMEPwREF2.1C. Please note that the trend calculations which are discussed in Ch~\ref{ch:Trends} are based only on 1) EMEP emissions, while 2) EMEPwREF2.1C emissions are used in the status run (Ch~\ref{ch:chapterStatus} and in source-receptor calculations (Appendix~\ref{ch:appx_sr2019}).\\
...
\bibliography{Refs2021} % ,EMEP_Reports}
