...
\old{MODIFY: This year two different estimates for primary PM emissions have been used in the modeling: 1) EMEP emissions as prepared by CEIP based on the official data submissions for 2019, and 2) EMEP PM emissions where condensable organics from small-scale combustion are accounted for by using expert emission estimates for GNFR sector C from the TNO Ref2 data set. For more details please consult Chapter~\ref{ch:Condensables}. In this report 1) is referred to as EMEP and 2) is referred to as EMEPwRef2C. National emission totals for both data sets are shown in Table~\ref{tab:2019emisPM}.} \\
